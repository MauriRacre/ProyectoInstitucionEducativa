...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 24-02-2026 a las 16:41:20
...
INSERT INTO `servicios` (`id`, `nombre`, `descripcion`, `monto_base`, `activo`) VALUES
(1, 'ingles', 'Clases de ingles', 0.00, 1),
(2, 'ingles', 'Clases de ingles', 50.00, 1),
(3, 'Futsal', NULL, 100.00, 1);
