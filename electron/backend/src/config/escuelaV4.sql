...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 16-02-2026 a las 22:13:02
...
INSERT INTO `usuarios` (`id`, `nombre`, `username`, `email`, `password`, `rol`, `ping`) VALUES
(1, '', 'admin', NULL, '$2b$10$FQazmp101R3ovdli26QEOeIYT5of7BrY99a4zOGtc46dQAd9eaOKK', 'ADMIN', 0),
(2, 'Mauricio Ramos', 'mau', 'mauri.mdc.24@mail.com', '1234', 'ADMIN', 0);
